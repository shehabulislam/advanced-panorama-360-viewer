<div class="adv-pano-360-viewer"
     data-media-url="<?php echo esc_attr($attributes['mediaUrl']); ?>"
     data-show-controls="<?php echo esc_attr($attributes['showControls']); ?>"
     data-custom-controls="<?php echo esc_attr($attributes['customControls']); ?>"
